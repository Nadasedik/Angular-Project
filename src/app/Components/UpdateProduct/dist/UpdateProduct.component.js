...
exports.UpdateProductComponent = void 0;
var core_1 = require("@angular/core");
var UpdateProductComponent = /** @class */ (function () {
    function UpdateProductComponent(staticPrd, router) {
    ...
    UpdateProductComponent.prototype.UpadateProduct = function (id, name, Qnt, price, Img, cID) {
        this.UpdatedProduct = {
            ID: id,
            Name: name,
            Quantity: Qnt,
